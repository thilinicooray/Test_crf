...
from utils.HDN_utils import check_recall
...
class Hierarchical_Descriptive_Model(HDN_base):
    ...
    def evaluate(self, im_data, im_info, gt_regions, thr=0.5, nms=False, top_Ns = [100], use_gt_boxes=False, use_gt_regions=False, only_predicate=False):
